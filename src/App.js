      ...
      <div className="countryImg">
        ...
        {weather && (
          <div className="szeged">
            ...
            {modal &&(<motion.div variants={modalAnim} initial="hidden" animate="show" exit="exit" className="openModal">
            <h3 onClick={toggleModal}>{weather.location.name}</h3>
        ...
        {weather1 && (
          <div className="pecs">
            ...
            {modal1 &&(<motion.div variants={modalAnim} initial="hidden" animate="show" exit="exit" className="openModal">
            <h3  onClick={toggleModal1}>{weather1.location.name}</h3>
        ...
        {weather2 && (
          <div className="keszthely">
            ...
            {modal2 &&(<motion.div variants={modalAnim} initial="hidden" animate="show" exit="exit" className="openModal">
            <h3   onClick={toggleModal2}>{weather2.location.name}</h3>
        ...
        {weather3 && (
          <div className="szombathely">
            ...
            {modal3 &&(<motion.div variants={modalAnim} initial="hidden" animate="show" exit="exit" className="openModal">
            <h3   onClick={toggleModal3}>{weather3.location.name}</h3>
        ...
        {weather4 && (
          <div className="sopron">
            ...
            <div onClick={toggleModal1} className="overlay"></div>
            {modal4 &&(<motion.div variants={modalAnim} initial="hidden" animate="show" exit="exit" className="openModal">
            <h3 onClick={toggleModal4}>{weather4.location.name}</h3>
        ...
        {weather5 && (
          <div className="gyor">
            ...
            {modal5 &&(<motion.div variants={modalAnim} initial="hidden" animate="show" exit="exit" className="openModal">
            <h3 onClick={toggleModal5}>{weather5.location.name}</h3>
        ...
        {weather6 && (
          <div className="szekesfehervar">
            ...
            {modal6 &&(<motion.div variants={modalAnim} initial="hidden" animate="show" exit="exit" className="openModal">
            <h3 onClick={toggleModal6}>{weather6.location.name}</h3>
        ...
        {weather7 && (
          <div className="budapest">
            ...
            {modal7 &&(<motion.div variants={modalAnim} initial="hidden" animate="show" exit="exit" className="openModal">
            <h3 onClick={toggleModal7}>{weather7.location.name}</h3>
        ...
        {weather8 && (
          <div className="szolnok">
            ...
            {modal8 &&(<motion.div variants={modalAnim} initial="hidden" animate="show" exit="exit" className="openModal">
        ...
        {weather9 && (
          <div className="miskolc">
            ...
            {modal9 &&(<motion.div variants={modalAnim} initial="hidden" animate="show" exit="exit" className="openModal">
            <h3 onClick={toggleModal9}>{weather9.location.name}</h3>
        ...
        {weather10 && (
          <div className="debrecen">
            ...
            {modal10 &&(<motion.div variants={modalAnim} initial="hidden" animate="show" exit="exit" className="openModal">
            <h3 onClick={toggleModal10}>{weather10.location.name}</h3>
